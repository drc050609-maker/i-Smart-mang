...
const initialState: AddClassStudentsState = {};

export function AddClassStudentsDialog({
  classId,
  students,
}: {
  classId: number;
  ...
  function handleStudentAdded(student: StudentOption) {
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              ...
              >
                ...
                <div>
                  <label htmlFor="classStudents" className="sr-only">
                    {t("common.student")}
                  </label>
                  <StudentMultiCombobox
                    id="classStudents"
                ...
                <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                  ...
                  >
                    {pending ? t("common.adding") : t("common.addToClass")}
                  </button>
                </div>
              </form>
            </DialogPanel>
