...
export function AddLeadDialog({
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const phoneNumber = formData.get("phoneNumber")?.toString().trim();
                ...
                if (!parentFirstName) {
      setError(t("leads.studentFirstNameRequired"));
      return;
    }

    if (!phoneNumber) {
      setError(t("leads.phoneRequired"));
      return;
    }
                ...
                <div>
                  ...
                  <div className="mt-3 grid gap-4 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input id={`${idPrefix}-street1`} name="street1" className={inputClassName} />
                      </div>
                    </div>
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2">
                        <input id={`${idPrefix}-street2`} name="street2" className={inputClassName} />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-2">
                        <input id={`${idPrefix}-city`} name="city" className={inputClassName} />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative mt-2">
                        <select id={`${idPrefix}-state`} name="state" defaultValue="" className={selectClassName}>
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        <input id={`${idPrefix}-zipCode`} name="zipCode" className={inputClassName} />
                      </div>
                    </div>
                  </div>
                </div>
