                ...
                <div className="mt-3 w-full text-left sm:mt-0">
                  ...
                  >
                    <div className="grid gap-5 sm:grid-cols-2">
                      <div>
                        <label htmlFor="teacherFirstName" className={labelClassName}>
                          {t("common.firstName")}
                        </label>
                        <div className="mt-2">
                          <input
                      ...
                      <div>
                        <label htmlFor="teacherLastName" className={labelClassName}>
                          {t("common.lastName")}
                        </label>
                        <div className="mt-2">
                          <input
                    ...
                    <div>
                      <label htmlFor="teacherPhone" className={labelClassName}>
                        {t("common.phone")}
                      </label>
                      <div className="mt-2">
                        <input
