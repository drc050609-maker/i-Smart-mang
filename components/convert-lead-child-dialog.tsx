...
export function ConvertLeadChildDialog({
  leadId,
  child,
}: {
  leadId: number;
  ...
  const childName = formatLeadChildName(child);
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                {t("leads.convertToStudentDescription", { name: childName })}
              </p>
              ...
              <form ref={formRef} action={formAction} className="mt-6 space-y-4">
                ...
                <div>
                  <label htmlFor={`convert-credits-${child.id}`} className={labelClassName}>
                    {t("leads.startingClassSessions")}
                  </label>
                  <div className="mt-2">
                    <input
                      id={`convert-credits-${child.id}`}
                ...
                <div className="flex justify-end gap-3">
                  ...
                  >
                    ...
                    {pending ? t("common.processing") : t("leads.convertToStudent")}
                  </button>
                </div>
              </form>
            </DialogPanel>
