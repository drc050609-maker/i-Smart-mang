...
import { deleteStudentPhoneContact } from "@/app/(dashboard)/students/actions";

export function DeletePhoneButton({
  studentId,
  phoneId,
}: {
  studentId: number;
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={t("common.deletePhoneConfirm")}
