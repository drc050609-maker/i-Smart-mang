...
import type { LeadChild } from "@/lib/lead";
...
export function EditLeadChildDialog({
  leadId,
  child,
  open,
  onClose,
  ...
  const [state, formAction, pending] = useActionState(updateLeadChild, initialState);
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            ...
            <form ref={formRef} action={formAction} className="mt-6 space-y-4">
              ...
              <div>
                <label htmlFor={`${idPrefix}-background`} className={labelClassName}>
                  {t("leads.background")}
                </label>
                <div className="mt-2">
                  <textarea
              ...
              <div>
                <label htmlFor={`${idPrefix}-experience`} className={labelClassName}>
                  {t("leads.experience")}
                </label>
                <div className="mt-2">
                  <textarea
