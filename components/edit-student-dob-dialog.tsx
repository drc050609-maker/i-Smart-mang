...
const initialState: UpdateStudentDobState = {};
...
export function EditStudentDobDialog({
  studentId,
  dob,
}: {
  studentId: number;
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="dob"
                      type="date"
                      defaultValue={toDateInputValue(dob)}
