...
function toDateInputValue(dob: string | null) {
  if (!dob) return "";
            ...
            >
              ...
              >
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="editTeacherFirstName" className={labelClassName}>
                      {t("common.firstName")}
                    </label>
                    <div className="mt-2">
                      <input
                  ...
                  <div>
                    <label htmlFor="editTeacherLastName" className={labelClassName}>
                      {t("common.lastName")}
                    </label>
                    <div className="mt-2">
                      <input
                        id="editTeacherLastName"
                        name="lastName"
                        type="text"
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="dob"
                      type="date"
                      defaultValue={toDateInputValue(teacher.dob)}
                      className={inputClassName}
                    />
                  </div>
                </div>
                ...
                <div>
                  <label htmlFor="editTeacherPhone" className={labelClassName}>
                    {t("common.phone")}
                  </label>
                  <div className="mt-2">
                    <input
