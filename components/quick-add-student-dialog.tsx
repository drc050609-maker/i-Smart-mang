...
export function QuickAddStudentDialog({
  ...
  onCreated: (student: StudentOption) => void;
  ...
  useEffect(() => {
    ...
    if (state.success && state.student) {
      onCreatedRef.current(state.student);
      formRef.current?.reset();
      setError(null);
      setDialogOpen(false);
    }
  }, [state.error, state.success, state.student]);
            ...
            >
              ...
              >
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="quickAddFirstName" className={labelClassName}>
                      {t("common.firstName")}
                    </label>
                    <div className="mt-2">
                      <input
                        id="quickAddFirstName"
                        name="firstName"
                        type="text"
                        required
                  ...
                  <div>
                    <label htmlFor="quickAddLastName" className={labelClassName}>
                      {t("common.lastName")}
                    </label>
                    <div className="mt-2">
                      <input
                ...
                <div>
                  <label htmlFor="quickAddDob" className={labelClassName}>
                ...
                <div>
                  <label htmlFor="quickAddStartingClassCredits" className={labelClassName}>
                    {t("common.startingClassSessions")}
                  </label>
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {t("common.startingClassSessionsHelp")}
                  </p>
                  <div className="mt-2">
                    <input
                      id="quickAddStartingClassCredits"
                ...
                <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                  ...
                  >
                    {pending ? t("common.saving") : t("common.saveStudent")}
                  </button>
                </div>
              </form>
            </DialogPanel>
