...
export const CLASS_SUBJECT_TRANSLATIONS: Record<string, string> = {
  ...
  "Sing & Play": "边弹边唱",
  "Model / Catwalk": "模特走秀",
  "Model / Catwalk (Class 1)": "模特走秀（1 班）",
  "Model / Catwalk (Class 2)": "模特走秀（2 班）",
  "Modeling / Catwalk": "模特走秀",
  Art: "画画",
  "1-to-1 Art": "一对一画画",
  "Jazz Dance": "爵士舞",
  Jazz: "爵士舞",
...
const CLASS_SUBJECT_KEYWORD_REPLACEMENTS: [RegExp, string][] = [
  ...
  [/jazz\s*dance/gi, "爵士舞"],
  [/model(?:ing)?(?:\s*\/\s*cat\s*-?\s*walk)?|\bcat\s*-?\s*walk\b/gi, "模特走秀"],
